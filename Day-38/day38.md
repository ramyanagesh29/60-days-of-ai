...
![Live Statistics](images/03-live-statistics.png)

The application tracks WPM, Raw WPM, accuracy, time, mistakes and typing streak in real time.

### 4. Programming Mode

![Programming Mode](images/04-programming-mode.png)
